def main():
    ...
    while cash_in and my_player.chips.total != 0:
        ...
        # is_player_standing = stand : True , bust : False
        is_player_standing = my_player.hand.stand_or_hit(my_deck, my_player.name)
    ...
    if my_player.chips.total < 100:
        ...
        print('you have: ' + str(my_player.chips.total) + ' chips')
    else:
